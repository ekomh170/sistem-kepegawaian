...
| **C**    | Upload bukti before/after (kini galeri multi-foto Sebelum/Sesudah — lihat §2.5)          | ✅ Tetap               | ✅ Utuh                                                         |
...
| 7   | **Seeder realistis**                              | Tanggal acuan **2026-06-30 (Selasa)**; check-in 7 hari terakhir dari rentang data dibiarkan `pending` agar antrian Verifikasi terisi; tambah setting `wa_admin`.                                                                                                                                                                                                                                                                                                                         |
...
| 10  | **Rename "Laporan", polish UI & seeder lanjutan** | Label resource Laporan → **"Laporan"** (`navigationLabel`/`modelLabel`/`pluralModelLabel`; judul **data** laporan tetap "Laporan Presensi …" sebagai pembeda jenis). Tombol **Simpan Lokasi** (Lokasi Kantor) dirapikan jadi footer action rata kanan. Seeder: galeri bukti Sebelum/Sesudah dibuat **bervariasi** (1-2 / 1-3 foto) + status pending/disetujui; **ProductionSeeder** kini ikut seed `wa_admin`.                                                                           |
